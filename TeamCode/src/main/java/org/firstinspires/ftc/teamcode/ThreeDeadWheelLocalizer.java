...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2143.440749426815; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2074.863742136777; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -976.6170778553872; // x position of the perpendicular encoder (in tick units)
    }
