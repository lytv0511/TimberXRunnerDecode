...
@TeleOp(name="StudioTestTeleop", group="TeleOp")
public class StudioTestTeleop extends LinearOpMode {
...
//    }
    ...
    private void loopLogic() {
        ...
        int expectedDistance = (mode == 2) ? 112 : 46;
